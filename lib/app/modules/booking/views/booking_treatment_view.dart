...
class BookingTreatmentView extends GetView<BookingController> {
  const BookingTreatmentView({super.key});
              ...
              children: [
                ...
                Obx(
                  () => BookingYesNoQuestionCard(
                    ...
                    selectedYes: controller.hasOngoingTreatment.value,
                    onChanged: controller.setOngoingTreatment,
                  ),
                ),
                const SizedBox(height: 20),
                const BookingSectionTitle(text: 'Specify The Treatment'),
                const SizedBox(height: 10),
                TextField(
                  controller: controller.treatmentDescriptionController,
                  minLines: 4,
                  maxLines: 4,
                ...
                Center(
                  child: AppButton(
                    text: 'Next',
                    onPressed: controller.onTreatmentNextPressed,
                    textSize: 13,
                    width: 123,
                    height: 35,
                    borderRadius: 8,
